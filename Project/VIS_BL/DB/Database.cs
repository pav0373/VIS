...
namespace VIS_BL.DB
{
    ...
    {
        private static readonly String ConnectionStringMsSql = "server=dbsys.cs.vsb.cz\\STUDENT;database=pav0373;user=pav0373;password=fHDYrCbLzd;";
        ...
        public bool Connect()
        {
            ...
            if (Connection.State != System.Data.ConnectionState.Open)
            {
                ...
                ret = Connect(ConnectionStringMsSql);
            }
            return ret;
        }
